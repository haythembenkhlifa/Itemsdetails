...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__regex_js__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parse_js__ = __webpack_require__(5);
...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-itemsdetails', __webpack_require__(8));
  Vue.component('detail-itemsdetails', __webpack_require__(11));
  Vue.component('form-itemsdetails', __webpack_require__(14));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    created: function created() {
        // console.log("number of itlem is");
    ...
    methods: {
        numberOfItems: function numberOfItems() {
            var items = 0;
            var dms = this.field.value || [];
            var arr = [];
            dms.filter(function (dm) {
                items = items + dm.quantity;
                return true;
            });
            return items;
        }
...
var render = function() {
  ...
  return _c("span", [_vm._v(_vm._s(this.numberOfItems()))])
}
var staticRenderFns = []
  ...
  return _c("div", { staticClass: "flex border-b border-40" }, [
    ...
    _c("div", { staticClass: "w-3/4 py-4 break-words" }, [
      _c("table", { staticClass: "table w-full" }, [
        ...
        _c(
          "tbody",
          _vm._l(this.field.value, function(dm) {
            return _c("tr", { key: dm.key }, [
              _c("td", { staticClass: "text-center" }, [
                _c("p", { staticStyle: { "font-weight": "bold" } }, [
                  _vm._v("x " + _vm._s(dm.quantity))
                ])
              ]),
              _vm._v(" "),
              _c("td", { staticClass: "text-center" }, [
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        addItem: function addItem() {
            ...
            this.error = false;
            var dms = this.dms.filter(function (dm) {
                return dm.width == _this.width && dm.height == _this.height && dm.length == _this.length && dm.weight == _this.weight;
            });
            if (dms.length > 0) {
        ...
        deleteItem: function deleteItem(key) {
            ...
            // }else{
            this.dms = this.dms.filter(function (dm) {
                return dm.key !== key;
            });
            //}
            // console.log("DMS");
        ...
        minusQuantity: function minusQuantity(dm) {
            if (dm.quantity > 1) {
        ...
        plusQuantity: function plusQuantity(dm) {
            var index = this.dms.indexOf(dm);
            this.dms[index].quantity = dm.quantity + 1;
            //console.log(this.dms[index].quantity);
        },
        ...
        handleConfirm: function handleConfirm(key) {
            if (key) {
                this.deleteItem(key);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__v1_js__ = __webpack_require__(18);
/* unused harmony reexport v1 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__v3_js__ = __webpack_require__(20);
/* unused harmony reexport v3 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__v4_js__ = __webpack_require__(22);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__v5_js__ = __webpack_require__(23);
/* unused harmony reexport v5 */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__nil_js__ = __webpack_require__(25);
/* unused harmony reexport NIL */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__version_js__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__parse_js__ = __webpack_require__(5);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__rng_js__ = __webpack_require__(3);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__v35_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__md5_js__ = __webpack_require__(21);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__v35_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sha1_js__ = __webpack_require__(24);
...
var render = function() {
  ...
  return _c(
    "default-field",
    { staticClass: "test", attrs: { field: _vm.field, errors: _vm.errors } },
    [
                      ...
                      "button",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.handleConfirm(_vm.selecteditem)
                          }
                        }
                      },
                      [_vm._v("\n      Delete\n    ")]
        ...
        [
          _c("div", {}, [
            _c("input", {
              ...
              ref: "widthinput",
              staticClass: "w-1/5 form-control form-input form-input-bordered",
              attrs: {
                type: "number",
                min: "0",
                step: "0.01",
                      ...
                      _c("td", { staticClass: "text-center" }, [
                        _c("div", { staticClass: "inline-block" }, [
                          _c(
                            ...
                            {
                              staticClass:
                                "inline-block btn btn-danger mr-2 px-2 pb-1 items-center rounded-full focus:outline-none",
                              attrs: {
                                disabled: dm.quantity == 1,
                                type: "button"
                              },
                              on: {
                                click: function($event) {
                                  return _vm.minusQuantity(dm)
                                }
                              }
                            },
                            [_vm._v("-")]
                          ...
                          _c(
                            "div",
                            {
                              staticClass: "text-center inline-block",
                          ...
                          _c(
                            ...
                            {
                              staticClass:
                                "inline-block btn btn-danger ml-2 px-2 pb-1 rounded-full items-center focus:outline-none",
                              staticStyle: { "background-color": "green" },
                              attrs: { type: "button" },
                              on: {
                                click: function($event) {
                                  return _vm.plusQuantity(dm)
                                }
                              }
                            },
                            [_vm._v("+")]
